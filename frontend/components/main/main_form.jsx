			...
			<div className="splash-background">
				...
				<div className="second-part">
					<div className="steps">
						...
						<p className="task-lower-text">As a Task-Creater, tell us what you need done, when and where it works for you. </p>
					</div>
					<div className="steps">
						<img className='steps-img' src={window.chooseURL} />
			
						<p className="task-text">&#9313; Choose Your Task</p>	
						<p className="task-lower-text">A Task-Doer will select the job based on the information.</p>		
					</div>					
					<div className="steps">
						<img className='steps-img' src={window.getURL} />
				
						<p className="task-text">&#9314; Get It Done</p>	
						<p className="task-lower-text">Your Task-Doer arrives and gets the job done. Pay securely and leave a review, all through MaskedHabbit.</p>
					</div>
